...
const Footer = () => {
  return (
    <footer className="py-16 px-6 md:px-12 bg-gradient-to-b from-secondary/30 to-secondary/50">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
          ...
          <div className="flex gap-6">
            ...
            <a href="#skills" className="text-foreground/70 hover:text-foreground transition-colors duration-300">Skills</a>
            <a href="#projects" className="text-foreground/70 hover:text-foreground transition-colors duration-300">Projects</a>
            <a href="#contact" className="text-foreground/70 hover:text-foreground transition-colors duration-300">Contact</a>
          </div>
          
          <div className="flex gap-4">
            <a href="#" className="p-2 rounded-lg bg-foreground/5 hover:bg-foreground/10 transition-colors duration-300">
